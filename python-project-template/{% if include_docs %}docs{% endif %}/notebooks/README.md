...
simply add the notebook name to the ``../notebooks.rst`` file. Be aware that you may
also need to update the ``../requirements.txt`` file if your notebooks have
dependencies that are not specified in ``../pyproject.toml``.
